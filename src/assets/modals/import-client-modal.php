...
<button type="button" class="btn btn-primary modal-button" data-toggle="modal" data-target="#importClientModal">Client importieren <i class="fa fa-download"></i></button>
